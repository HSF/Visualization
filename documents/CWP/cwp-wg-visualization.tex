...
\affiliation[o]{CERN, Geneva, Switzerland}%{ALICE, Warsaw, Poland}
...
\begin{figure*}
	...
	{\small Different examples of HEP event display applications: \subref{fig:ed-atlas}) ATLAS 3D event display \cite{ATLASED072015,ATLASVP12010}; \subref{fig:ed-cms} CMS 3D event display \cite{}; \subref{fig:ed-alice}) ALICE 3D event display \cite{}; \subref{fig:ed-lhcb}) LHCb 3D event display \cite{LHCbED}; \subref{fig:ed-belleii}) Belle II VR event display \cite{BelleIIVRED}; \subref{}) ... \cite{}} 
