...
from detector simulation to data analysis, all the way up until outreach and education.
In this chapter the definition, the status and the evolution of data visualization for HEP experiments will be presented.
After that, and based on the current experience, guidelines will be shaped and presented, for the upgrade of the current
HEP experiments and the preparation of the future ones.}
...
\author[e]{Benjamin Couturier}
\author[f]{Hadrien Grasland}
\author[g]{Oliver Gutsche}
\author[h]{Sergey Linev}
\author[i]{Alex Martyniuk}
\author[j,1]{Thomas McCauley}
\author[k]{Edward Moyse}
\author[l]{Alja Mrak Tadel}
\author[m]{Mark Neubauer}
\author[n]{Jeremi Niedziela}
\author[o]{Leo Piilonen}
\author[p]{Jim Pivarski}
\author[q]{Martin Ritter}
\author[r]{Tai Sakuma}
\author[l]{Matevz Tadel}
\author[e]{Barthélémy von Haller}
\author[s]{Ilija Vukotic}
\author[i]{Ben Waugh}
...
\affiliation[e]{CERN, Geneva, Switzerland}
\affiliation[f]{LAL, Université Paris-Sud and CNRS/IN2P3, Orsay, France}
\affiliation[g]{FNAL, Batavia IL, USA}
\affiliation[h]{GSI Darmstadt, Germany}
\affiliation[i]{University College London, London, UK}
\affiliation[j]{University of Notre Dame, Notre Dame IN, USA}
\affiliation[k]{University of Massachusetts, Amherst MA, USA}
\affiliation[l]{University of California at San Diego, San Diego CA, USA}
\affiliation[m]{University of Illinois, IL, USA}
\affiliation[n]{Warsaw, Poland}
\affiliation[o]{Virginia Tech, VA, USA}
\affiliation[p]{Princeton University, Princeton PA, USA}
\affiliation[q]{LMU Munich, Munich, Germany}
\affiliation[r]{University of Bristol, Bristol, UK}
...
%Data access via the experimental software framework
...
%Data access via intermediate format
...
\bibitem{ATLASAtlantis} http://www.cern.ch/atlantis

\bibitem{ATLASED042016} https://cds.cern.ch/record/2148236

\bibitem{ATLASED072015} %FIX https://twiki.cern.ch/twiki/pub/AtlasPublic/EventDisplayRun2Collisions/JiveXML_271298_403602858-RZ-LegoPlot-EventInfo-RZ-YX-2015-08-06-15-01-42.png

\bibitem{ATLASEventDisplays2016} https://indico.cern.ch/event/505613/contributions/2228333/

\bibitem{ATLASGeoModel2004} J. Boudreau and V. Tsulaia, “The GeoModel Toolkit for Detector Description”, CHEP 2004, https://cds.cern.ch/record/865601/
...
\bibitem{ATLASMinerva} http://cern.ch/atlas-minerva

\bibitem{ATLASPersint2012} http://cds.cern.ch/record/1501131?ln=en,  https://twiki.cern.ch/twiki/bin/viewauth/Atlas/PersintWiki

\bibitem{ATLASRift} https://atlasrift.web.cern.ch/

\bibitem{ATLASTada2016} G. Sabato et al., CHEP 2016, “ATLAS Fast Physics Monitoring: TADA”,  https://cds.cern.ch/record/2244283

\bibitem{ATLASTracer2015} https://atlas-tracer.web.cern.ch/

\bibitem{ATLASVP12010} T. Kittelmann, V. Tsulaia, J. Boudreau and E. Moyse, “The Virtual Point 1 event display for the ATLAS experiment”, Journal of Physics: Conference Series, 2010, vol. 219 n. 3 ( http://iopscience.iop.org/1742-6596/219/3/032012) - website:  https://atlas-vp1.web.cern.ch/atlas-vp1

\bibitem{BelleIIVR} http://www1.phys.vt.edu/~piilonen/VR/

\bibitem{Bokeh2014} http://www.bokeh.pydata.org

\bibitem{CERNCamelia} http://medialab.web.cern.ch/content/camelia

\bibitem{CERNTEV} [https://gitlab.cern.ch/CERNMediaLab/TEV] ?

\bibitem{CMSISpyWebGL} T. McCauley “A browser-based event display for the CMS experiment at the LHC using WebGL”, to appear in the proceedings of CHEP2016, (http://cern.ch/ispy-webgl)

\bibitem{CMSFireworks} L.A.T. Bauerdick et al., “Event display for the visualization of CMS events”, J.Phys.Conf.Ser. 331 (2011) 072039 https://twiki.cern.ch/twiki/bin/view/CMSPublic/WorkBookFireworks
...
\bibitem{EpicUnreal} https://www.unrealengine.com

\bibitem{GoogleCardboard} https://vr.google.com/cardboard/

\bibitem{HSFVis2017} “HSF Visualization Workshop” (https://indico.cern.ch/event/617054/)

\bibitem{HSFVizRepo} https://github.com/HEP-SF/Visualization
...
\bibitem{LHCbEventDisplays2017} B. Couturier, “Event Displays in LHCb” (https://indico.cern.ch/event/617054/contributions/2529736/)

\bibitem{LHCbOnline2014} https://lhcb-public.web.cern.ch/lhcb-public/lbevent2/lbevent/

\bibitem{LHCbPanoramix} http://lhcb-comp.web.cern.ch/lhcb-comp/frameworks/Visualization/

\bibitem{LHSee} https://www2.physics.ox.ac.uk/about-us/outreach/public/lhsee

\bibitem{OpenGL1992} https://www.opengl.org/about/
...
\bibitem{Plotly2015} https://plot.ly
...
\bibitem{ROOTEVE2007} https://root.cern.ch/eve

\bibitem{ThreeJSXXXX} https://threejs.org/
...
\bibitem{Tukey1962} J. W. Tukey, “The Future of Data Analysis”, The Annals of Mathematical Statistics Volume 33, Number 1, 1-67 (1962) (http://www.jstor.org/stable/2237638)

\bibitem{VanderPlas2017} https://speakerdeck.com/jakevdp/pythons-visualization-landscape-pycon-2017

\bibitem{WebGL2011} https://www.khronos.org/webgl/

\bibitem{glTF} https://www.khronos.org/gltf/

\bibitem{SketchFab} https://sketchfab.com

\bibitem{SketchFabBelleII} https://sketchfab.com/models/6c7aa0c71dc64079b08a0dddfa756ef3

\bibitem{Unity3D} https://unity3d.com

\bibitem{WebVR} https://w3c.github.io/webvr/

\bibitem{AFrame} https://aframe.io/

\bibitem{BelleII} http://belle2.jp
