...
%as like as with the standalone visualization tools; without the possibility of having real interactive visualizations,
...
\bibitem{hsf-cwo-roadmap} "A Roadmap for HEP Software and Computing R\&D for the 2020s", HSF-CWP-2017-001, HSF-CWP-2017-01, FERMILAB-PUB-17-607-CD, arXiv:1712.06982
...
\bibitem{rootjs} https://root.cern.ch/js

\bibitem{alieve} AliEve ref needed

\bibitem{Geant4} Geant4 ref needed

\bibitem{seaborn} https://seaborn.pydata.org

\bibitem{phystat05} http://www.physics.ox.ac.uk/phystat05/Talks/PhyStat05-paterno.pdf

\bibitem{continuum} https://www.continuum.io/
...
\bibitem{CMSISpyWebGL} T. McCauley "A browser-based event display for the CMS experiment at the LHC using WebGL", J.Phys.Conf.Ser. 898 (2017) no.7, 072030 (http://cern.ch/ispy-webgl)
